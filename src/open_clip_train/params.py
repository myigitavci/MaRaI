...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Freeze all but last n layers of the model.",
    )
    parser.add_argument(
        "--delta",
        type=float,
        default=0.5,
        help="Weight of the vision loss in the final CLIP loss.",
    )
    parser.add_argument(
        "--lam",
        type=float,
        default=None,
        help="Weight of the vision loss in the final loss.",
    )
    parser.add_argument(
        "--tsne",
        default=True,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Calculate metrics on all dataset"
    )
    parser.add_argument(
        "--unique",
        default=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Supervised contrastive loss with multiple positives per anchor."
    )
    parser.add_argument(
        "--visiononly",
        default=False,
        action="store_true",
        help="Train only the vision encoder."
    )
    parser.add_argument(
        "--tracepreds",
        default=False,
        action="store_true",
        help="Trace back the outputs of top 10 predictions."
    )
    parser.add_argument(
        "--tabular",
        default=False,
        action="store_true",
        help="Train with tabular data."
    )
    parser.add_argument(
        "--distance",
        default=False,
        action="store_true",
        help="Add distance to the loss."
    )
    parser.add_argument(
        "--freeze",
        default=False,
        action="store_true",
        help="Freeze text encoder except 2 last layers."
    )
    parser.add_argument(
        "--metrics",
        default=False,
        action="store_true",
        help="Calculate metrics on all validation points."
    )
    parser.add_argument(
        "--csv-separator",
        type=str,
